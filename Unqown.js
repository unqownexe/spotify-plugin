/**
 * @name SpotifyPremium[Supporter]
 * @author UnqownExe
 * @authorId 791255637920972801
 * @version Release
 * @description Spotify'a para vermeden arkadaşlarınla dinlemek mi? Off... Harika be!
 * @website https://www.unqown.xyz
 * @updateUrl 
 */
/*@cc_on
@if (@_jscript)
